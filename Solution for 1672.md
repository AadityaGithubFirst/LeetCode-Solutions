...
You are given an m x n integer grid accounts where accounts[i][j] is the amount of money the $$i^(^t^h^)$$ customer has in the j​​​​​​​ bank. Return the wealth that the richest customer has.
